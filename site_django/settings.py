...
SECRET_KEY = 'django-insecure-a^!$v5&)@ne92fe=-6hw%=wlj#!ey3%j%9ctkp_=2p0j3jg(1g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'site_django' /'templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [BASE_DIR / 'site_django' /'static']
...
EMAIL_FROM_ADDRESS = 'vorduk98@gmail.com'  # mandatory
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'vorduk98@gmail.com'
